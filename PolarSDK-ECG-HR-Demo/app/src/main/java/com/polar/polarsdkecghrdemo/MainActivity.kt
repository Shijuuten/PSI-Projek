...
class MainActivity : AppCompatActivity() {
    ...
    private fun showDialog(view: View) {
        ...
        dialog.setTitle("Masukkan ID Device Polar Anda")
        ...
        dialog.setNegativeButton("Batal") { dialogInterface: DialogInterface, _: Int -> dialogInterface.cancel() }
        dialog.show()
    }
    ...
    private fun checkBT() {
        ...
        if (bluetoothAdapter == null) {
            showToast("Device Tidak memiliki support Bluetooth")
            return
        }
